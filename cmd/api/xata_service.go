...
var xataAPIKey = internals.GetEnvVariable("XATA_API_KEY")
var baseURL = internals.GetEnvVariable("XATA_DATABASE_URL")
...
func (app *Config) createTodoService(newTodo *internals.TodoRequest) (*internals.TodoResponse, error) {
	createTodo := internals.TodoResponse{}
	jsonData := internals.Todo{
...
func (app *Config) getAllTodosService() ([]*internals.Todo, error) {
	var todos []*internals.Todo
	...
	defer resp.Body.Close()
	var response struct {
		Records []*internals.Todo `json:"records"`
	}
